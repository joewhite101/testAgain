    ...
    86: function(e, t, n) {
              ...
              ? O.a.createElement(
                  ...
                  O.a.createElement(
                    ...
                    O.a.createElement(
                      C.a,
                      null,
                      O.a.createElement(S.a, null, O.a.createElement('span', null, a.a.t('entities.conference.asdf')))
                    )
                  ),
      ...
      var _ = (function(e) {
        function t() {
          ...
          return (
            ((n = Object(f.a)(this, (e = Object(p.a)(t)).call.apply(e, [this].concat(a)))).theme = Object(Y.a)()),
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 3:
                              (t = e.sent),
                                ...
                                this.setState({ conferences: n, notificationStatus: null, notificationMessage: null }),
                                (e.next = 11);
                              break;
                            case 8:
            ...
            },
            {
              ...
              value: function(e) {
                (0, this.props.onError)(e),
                  this.setState({ notificationStatus: 'error', notificationMessage: a.a.t('common.couldNotFetchData') });
              }
            },
            {
              key: 'render',
          ...
          Object(u.a)(t, [
            {
              ...
              value: function() {
                ...
                var r = O.a.createElement(
                  ...
                  {
                    onError: function(t) {
                      var n = new CustomEvent(''.concat('Conference.table.', 'error'), { detail: { error: t } });
                      e.dispatchEvent(n);
                    },
                    onSelect: function(t) {
                      var n = new CustomEvent(''.concat('Conference.table.', 'select'), { detail: { item: t } });
                      e.dispatchEvent(n);
                    }
                  },
                  null
