(window['webpackJsonpconference-details-widget'] = window['webpackJsonpconference-details-widget'] || []).push([
  ...
  [
    ...
    function(e, t, n) {
      ...
      function T() {
        for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n];
        ('string' === typeof t[0] && O[t[0]]) || ('string' === typeof t[0] && (O[t[0]] = new Date()), E.apply(void 0, t));
      }
      function C(e, t, n) {
      ...
      function _(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          n = t.i18n,
          r = Object(l.useContext)(y),
          i = (b() && r) || {},
          o = i.i18n,
          u = i.defaultNS,
          s = n || o || w();
        if ((s && !s.reportNamespaces && (s.reportNamespaces = new k()), !s)) {
        ...
        var j = [E.t, s, m];
        if (((j.t = E.t), (j.i18n = s), (j.ready = m), m)) return j;
        if (!m && !p) return j;
          ...
          function r(r) {
            var o = r.forwardedRef,
              ...
              f = (function(e) {
                ...
                return e;
              })({}, l, { t: c[0], i18n: c[1], tReady: c[2] });
            return t.withRef && o && (f.ref = o), u.a.createElement(n, f);
          }
          (r.displayName = 'withI18nextTranslation('.concat(j(n), ')')), (r.WrappedComponent = n);
          return t.withRef
            ? u.a.forwardRef(function(e, t) {
                return u.a.createElement(r, L()({}, e, { forwardedRef: t }));
              })
            : r;
        };
      }
      ...
      t.a = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          N = (function(e) {
            ...
            function T(e) {
              return Object(h.d)(e, g.text.primary) >= w ? g.text.primary : m.text.primary;
            }
            function C(e) {
          ...
          function() {
            ...
            return (
              ...
              a.a.useEffect(function() {
                u.current && on(o.current, e), (u.current = !0);
              }),
              nn(o.current, e.classes, l)
            );
          }
        );
      };
    ...
    function(e, t, n) {
        ...
        var t = e.prop,
          ...
          a = function(e) {
            ...
            return p(e, n, function(e) {
              var t;
              return (
                'function' === typeof a ? (t = a(e)) : Array.isArray(a) ? (t = a[e] || e) : ((t = h(a, e) || e), o && (t = o(t))),
      ...
      var v = u(
          m({ prop: 'border', themeKey: 'borders', transform: g }),
          m({ prop: 'borderTop', themeKey: 'borders', transform: g }),
          m({ prop: 'borderRight', themeKey: 'borders', transform: g }),
          m({ prop: 'borderBottom', themeKey: 'borders', transform: g }),
          m({ prop: 'borderLeft', themeKey: 'borders', transform: g }),
        ...
        k = u(m({ prop: 'color', themeKey: 'palette' }), m({ prop: 'bgcolor', cssProperty: 'backgroundColor', themeKey: 'palette' })),
        w = m({ prop: 'boxShadow', themeKey: 'shadows' });
      function S(e) {
        return e <= 1 ? ''.concat(100 * e, '%') : e;
      }
      var E = m({ prop: 'width', transform: S }),
        O = m({ prop: 'maxWidth', transform: S }),
        T = m({ prop: 'minWidth', transform: S }),
        C = m({ prop: 'height', transform: S }),
        j = m({ prop: 'maxHeight', transform: S }),
        P = m({ prop: 'minHeight', transform: S }),
        R =
          (m({ prop: 'size', cssProperty: 'width', transform: S }),
          m({ prop: 'size', cssProperty: 'height', transform: S }),
          u(E, O, T, C, j, P)),
        N = n(32);
      var _ = { m: 'margin', p: 'padding' },
        M = { t: 'Top', r: 'Right', b: 'Bottom', l: 'Left', x: ['Left', 'Right'], y: ['Top', 'Bottom'] },
      ...
      var Y = function(e) {
          return function(t) {
            ...
            var c = B.a.forwardRef(function(t, n) {
              var r = t.children,
                ...
                f = s(t),
                d = Object(H.a)(f.root, o),
                p = c;
              if ((a && (p = Q(p, a)), l)) return B.a.cloneElement(r, Object(i.a)({ className: Object(H.a)(r.props.className, d) }, p));
              if ('function' === typeof r) return r(Object(i.a)({ className: d }, p));
              var h = u || e;
              return B.a.createElement(h, Object(i.a)({ ref: n, className: d }, p), r);
            });
            return K()(c, e), c;
          };
        },
        ...
        J = l(u(v, y, b, x, k, w, R, F, U)),
        Z = G('div')(J, { name: 'MuiBox' });
      t.a = Z;
    },
    function(e, t, n) {
      'use strict';
...
//# sourceMappingURL=2.4508e2a3.chunk.js.map
